  ...
  return (
    <div className='mt-4'>
      ...
      <div className='flex justify-center mt-5 w-full'>
        <div className='grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-16'>
          {objectFood.map((food) => (
      ...
      <div className='flex justify-center w-full mt-16 md:mt-8'>
        <div className='grid grid-cols-1 gap-16 sm:grid-cols-2 md:mr-5 md:ml-0 md:grid-cols-3 md:gap-10 lg:gap-16
