...
const page = () => {
  ...
  const btnConfirm = (e)=>{
    e.preventDefault()
    user.update({ firstName: inputFirstName.current.value, lastName: inputLastName.current.value });
  }
    ...
    <div className="mt-8">
      <div className="w-full flex flex-col">
        <div className="flex justify-center">
          <p className="font-medium text-2xl">Dados Pessoais</p>
        </div>
        ...
        <Dialog open={active} onOpenChange={setActive}>
          <DialogContent className="p-5">
            <DialogTitle className="font-base text-lg">
